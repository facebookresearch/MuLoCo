...
'use_polar_express': True,    # Whether to use Polar Express Sign Method
...
fault_tolerance = {'enable': False,
                     ...
                     'use_gpa': False,
                     'use_continous_centering': False,
                     'use_periodic_centering': False,
    'sync_steps': 30,
    'module_fqns_per_model_fragment': [
        ['tok_embeddings', 'layers.0', 'layers.1', 'layers.2', 'layers.3'],
        ['layers.4', 'layers.5', 'layers.6', 'layers.7'],
        ['layers.8', 'layers.9', 'layers.10', 'layers.11', 'norm', 'output'],
    ],
    'num_fragments': 3,
}
