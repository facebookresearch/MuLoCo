...
model = {'converters': [],
        ...
        #   'flavor': "llama3-w3584-d42-h28_qk_torch-rmsnorm_pa_pf", #10B
        #   'flavor': "llama3-w4096-d48-h32_qk_torch-rmsnorm_pa_pf", #15B
...
training = {'compile': True,
              ...
              'gc_debug': False,
              'gc_freq': 50,
              'global_batch_size': 16*8,
              'local_batch_size': 16,
              'eval_global_batch_size': 4*8,
              'eval_local_batch_size': 4,
              'train_num_workers': 4,
              'val_num_workers': 2,
              'max_norm': 1.0,
