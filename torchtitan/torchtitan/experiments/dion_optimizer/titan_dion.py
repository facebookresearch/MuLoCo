...
class DionOptimizersContainer(OptimizersContainer):
    ...
    def _setup_device_meshes(self, parallel_dims: ParallelDims) -> tuple[
        ...
        # print("in _setup_device_meshes")
        # print(f"replicate_mesh: {replicate_mesh}")
        # print(f"outer_shard_mesh: {outer_shard_mesh}")
        # print(f"inner_shard_mesh: {inner_shard_mesh}")
        # print(f"world_mesh: {world_mesh}")
        # print(f"parallel_dims: {parallel_dims}")
        # print(f"parallel_dims.dp_replicate_enabled: {parallel_dims.dp_replicate_enabled}")
        # exit(0)
...
class DionFTOptimizersContainer(DionOptimizersContainer):
    def __init__(
        self,
        model_parts: list[nn.Module],
        dion_config: DionOptimizerConfig,
        ...
        super().__init__(model_parts, dion_config, parallel_dims)
