    ...
    **Note**
    ...
    def linear_warmup_stable_decay(
        ...
        if current_step < warmup_steps:
            ...
            if warmup_min_factor is not None:
                curr_adjustment = warmup_min_factor + (1 - warmup_min_factor) * float(current_step / warmup_steps)
            else:
    ...
    lr_lambda = functools.partial(
        ...
        lr_min=lr_min,
        warmup_min_factor=job_config.lr_scheduler.warmup_min_factor,
    )
